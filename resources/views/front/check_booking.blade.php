...
<body>
    <div class="relative flex flex-col w-full min-h-screen max-w-[640px] mx-auto bg-[#F8F8F9]">
        <main class="flex flex-col justify-center items-center w-full px-8 m-auto">
            <form action="{{ route('front.check_booking_details') }}" class="flex flex-col w-[329px] shrink-0 rounded-[30px] p-5 gap-6 bg-white" method="POST">
                @csrf
                ...
                <div class="flex flex-col gap-[6px]">
                    ...
                    <div class="flex items-center rounded-full px-5 gap-[10px] bg-[#F8F8F9] transition-all duration-300 focus-within:ring-1 focus-within:ring-[#F97316]">
                        ...
                        <input type="text" name="bookId" id="bookId" class="appearance-none outline-none py-[14px] !bg-transparent w-full font-semibold text-sm leading-[21px] placeholder:font-normal placeholder:text-[#13181D]" placeholder="What’s your booking ID">
                    </div>
                </div>
                <div class="flex flex-col gap-[6px]">
                    ...
                    <div class="flex items-center rounded-full px-5 gap-[10px] bg-[#F8F8F9] transition-all duration-300 focus-within:ring-1 focus-within:ring-[#F97316]">
                        ...
                        <input type="tel" name="phone" id="phone" class="appearance-none outline-none py-[14px] !bg-transparent w-full font-semibold text-sm leading-[21px] placeholder:font-normal placeholder:text-[#13181D]" placeholder="What’s your number">
                    </div>
                </div>
